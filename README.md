...
```
$ python cnpj_hygiene.py base_clientes.xlsx

[*] Carregando: base_clientes.xlsx
[*] 8044 registros encontrados. Analisando...

+----------------------------------------------------------+
|        CNPJ-HYGIENE - Resultado da Higienizacao         |
+----------------------------------------------------------+
|  Total analisado     :   8044                           |
+----------------------------------------------------------+
|  Validos (matriz)    :   6804   84.6%                   |
+----------------------------------------------------------+
|  Filiais             :   1200   14.9%                   |
|  CPF                 :     27    0.3%                   |
|  Alfanumerico        :     13    0.2%                   |
+----------------------------------------------------------+
|  Para revisao manual :   1240   15.4%                   |
+----------------------------------------------------------+
|  cnpjs_validos.xlsx  ->  6804 CNPJs prontos             |
|  cnpjs_revisao.xlsx  ->  1240 itens para revisao        |
+----------------------------------------------------------+
